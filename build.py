...
PARTS = [
 ...
 ("Part IV · Quantum Mechanics", "Linear algebra, taken absolutely seriously.", [
  ...
  ("4.4","ch4-4","Domains, and the Adjoint's Domain",True),
  ("4.5","ch4-5","The Spectral Theorem in Infinite Dimensions",True),
  ("4.6","ch4-6","The Schrödinger Equation",False),
  ("4.7","ch4-7","Wells, Barriers, and Tunnelling",False),
  ("4.8","ch4-8","The Oscillator, and the Ladder",False),
  ("4.9","ch4-9","Commutators, Uncertainty, and Symmetry",False),
  ("4.10","ch4-10","The Classical Limit",False),
  ("4.11","ch4-11","The Angular Momentum Algebra",False),
  ("4.12","ch4-12","Spin, Orbitals, and Adding Angular Momenta",False),
  ("4.13","ch4-13","The Hydrogen Atom",False),
  ("4.14","ch4-14","The Degeneracy, and SO(4)",False),
  ("4.15","ch4-15","Perturbation Theory",False),
  ("4.16","ch4-16","The Fine Structure of Hydrogen",False),
  ("4.17","ch4-17","Transitions",False),
  ("4.18","ch4-18","Identical Particles",False),
  ("4.19","ch4-19","Density Matrices and Entanglement",False),
  ("4.20","ch4-20","Bell, Decoherence, and What Is Settled",False),
 ]),
