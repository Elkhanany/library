...
if __name__ == "__main__":
    ...
    import os as _o; _s=_o.path.dirname(_o.path.abspath(__file__)); sys.path.insert(0,_s)
    import library
    files = sys.argv[1:] or sorted(f for b in library.books() for f in glob.glob(_o.path.join(b.src, "*.html")))
    sys.exit(main(files))
